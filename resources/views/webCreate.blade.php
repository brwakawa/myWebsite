...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>We create custom websites & designs.</title>
        ...
        <meta name="keywords" content="best website making with best price,best website making site,website designing">
        <!-- Fonts -->
    ...
    <body>
      <div class="header">
        ...
        <img src="./images/lapCuted.jpg" class="img" alt="laptop photo">
        <div class="logo">
        ...
        <div class="nav">
          <strong  x-ms-format-detection="none">
            +964 7507921032
          </strong>
        </div>
      </div>
      ...
      <main>
        <div class="main">
          <h1 class="main-title">Website Develop & design</h1>
          <p class="main-para">We design and create websites for your business or organization to deliver leads, clients, and revenue.</p>
          <h3 class="main-headers">Types of websites we can do for you</h3>
          <ol class="list">
            <li>Blogs or Personal Website</li>
            <li>E-commerce Website</li>
            <li>Portfolio Website</li>
            <li>Online Community</li>
          </ol>
          <div class="tools">
            <h3 class="main-headers">What we use to build your website</h3>
            <ul class="list">
          ...
          <div class="related">
            <strong class="related-title">RELATED</strong>
      ...
      <footer>  Copyright &copy; 2019, inspiratin media. All rights reserved.</footer>
    </body>
</html>
